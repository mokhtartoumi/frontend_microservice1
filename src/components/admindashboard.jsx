...
const AdminDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch statistics
      const statsRes = await axios.get('http://localhost:3000/problems/stats');
      ...
      const recentRes = await axios.get('http://localhost:3000/problems/recent');
      setRecentProblems(recentRes.data);

      // Fetch available technicians
      const techRes = await axios.get('http://localhost:3000/techniciens/available');
